...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=site_settings"><span class='icon-field'><i class="fa fa-cogs"></i></span></a>
				<a href="index.php?page=users"><span class='icon-field'><i class="fa fa-users"></i></span></a>
			<?php endif; ?>
		</div>
